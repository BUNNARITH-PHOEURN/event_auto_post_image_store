...
<body>
    ...
    <div class="form-title">Material Request Form</div>
    ...
    <table class="info-table">
        ...
        <tr>
            <td class="info-label">Material Request ID</td>
            <td class="info-colon">:</td>
            <td class="info-value" colspan="4">{{ $data['MaterialRequestID'] }}</td>
        </tr>
        <tr>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th class="col-date">Material Name</th>
                <th class="col-desc">Description</th>
                <th class="col-price">UOM</th>
        ...
        <tbody>
            @foreach ($data['Items'] as $Item)
                <tr>
                    ...
                    <td class="col-date">{{ $Item['Name'] }}</td>
                    <td class="col-desc">{{ $Item['Description'] }}</td>
                    <td class="col-price" style="text-align: center">{{ $Item['UOM'] }}</td>
